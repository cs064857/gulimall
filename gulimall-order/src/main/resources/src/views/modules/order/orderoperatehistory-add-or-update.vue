<template>
  <el-dialog
    ...
    <el-form-item label="操作人[用戶；系統；後台管理員]" prop="operateMan">
      <el-input v-model="dataForm.operateMan" placeholder="操作人[用戶；系統；後台管理員]"></el-input>
    </el-form-item>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          operateMan: [
            { required: true, message: '操作人[用戶；系統；後台管理員]不能为空', trigger: 'blur' }
          ],
          createTime: [
