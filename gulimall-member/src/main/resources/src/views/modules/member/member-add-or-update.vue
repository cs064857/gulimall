<template>
  <el-dialog
    ...
    <el-form-item label="用戶名" prop="username">
      <el-input v-model="dataForm.username" placeholder="用戶名"></el-input>
    </el-form-item>
    ...
    <el-form-item label="用戶來源" prop="sourceType">
      <el-input v-model="dataForm.sourceType" placeholder="用戶來源"></el-input>
    </el-form-item>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          sourceType: [
            { required: true, message: '用戶來源不能为空', trigger: 'blur' }
          ],
          integration: [
          ...
          status: [
            { required: true, message: '啟用狀態不能为空', trigger: 'blur' }
          ],
          createTime: [
